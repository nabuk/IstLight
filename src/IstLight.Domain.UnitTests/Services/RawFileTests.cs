...
namespace IstLight.UnitTests.Services
{
    public class RawFileTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new RawFile(null, "csv", new byte[0]));
        }

        [Fact]
        public void ctor_NullFormat_Throws()
        {
            Assert.Throws<ArgumentNullException>(() => new RawFile("name", null, new byte[0]));
        }

        [Fact]
        public void ctor_NullData_Throws()
        {
            Assert.Throws<ArgumentNullException>(() => new RawFile("name", "csv", null));
        }
        ...
        public void Name_FromCtorArg_IsStored()
        {
            ...
            var sut = new RawFile(name, "csv", new byte[0]);
        ...
        public void Format_FromCtorArg_IsStored()
        {
            ...
            var sut = new RawFile("name", format, new byte[0]);
        ...
        public void Data_FromCtorArg_IsStored()
        {
            ...
            var sut = new RawFile("name", "format", data);
